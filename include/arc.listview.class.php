...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<li><span class=\"pageinfo\">共 1页".$this->TotalResult."条记录</span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li><span class=\"pageinfo\">共 0页".$this->TotalResult."条记录</span></li>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<li><span class=\"pageinfo\">共 {$totalpage}页".$this->TotalResult."条</span></li>\r\n";
        ...
        {
            $indexpage="<li class='onlyli'>首页</li>\r\n";
        }
