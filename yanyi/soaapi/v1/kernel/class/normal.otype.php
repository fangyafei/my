...
class NormalOrder extends BaseOrder
{
    ...
    function submit($data){
		...
		if(!$baseinfo){
			...
			return array('stateCode'=>1,'oInfo'=>'订单基本信息验证失败');
		}
    	...
    	{
    		/* 收货人信息验证不通过 */
    		return array('stateCode'=>1,'oInfo'=>'收货人信息验证不合法');
    	}
    	...
    	{
    		/* 保存基本信息失败 */
    		return array('stateCode'=>1,'oInfo'=>'保存基本信息失败');
    	}
    	...
    	{
    		/* 保存地址失败 */
    		return array('stateCode'=>1,'oInfo'=>'保存收获地址失败');
    	}
    	...
    	if(!$res){
    		/* 保存优惠活动失败 */
    		return array('stateCode'=>1,'oInfo'=>'保存优惠活动失败');
    	}
    	...
    	{
    		/* 保存商品数据 */
    		return array('stateCode'=>1,'oInfo'=>'保存商品数据失败');
    	}
