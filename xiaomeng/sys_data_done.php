...
function PutInfo($msg1,$msg2)
{
    ...
    $msginfo = "<html>\n<head>
        ...
        <title>如果你看到这个页面，说明你做了管家不允许的操作</title>
        <base target='_self'/>\n</head>\n<body leftmargin='0' topmargin='0'>\n<center>
        <br/>
        <div style='width:400px;padding-top:4px;height:24;font-size:10pt;border-left:1px solid #cccccc;border-top:1px solid #cccccc;border-right:1px solid #cccccc;background-color:#DBEEBD;'>房亚飞友情提醒！</div>
